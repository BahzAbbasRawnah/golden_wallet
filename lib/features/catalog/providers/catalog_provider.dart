...
class CatalogProvider extends ChangeNotifier {
  ...
  Future<void> initialize() async {
    ...
    try {
      // Load categories from JSON file using the data service
      _categories = await data_service.CatalogDataService.loadCategories();

      // Load products with current filter and pagination
