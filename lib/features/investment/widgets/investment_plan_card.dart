          ...
          Row(
            ...
            children: [
              ...
              Container(
                padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 6),
                decoration: BoxDecoration(
                  color: plan.riskLevel.color.withOpacity(0.1),
                  borderRadius: BorderRadius.circular(20),
                ),
                child: Row(
                  children: [
            ...
            children: [
              ...
              Expanded(
                child: _buildDetailItem(
                  ...
                  value: '${plan.expectedReturnsPercentage}%',
              ...
              Expanded(
                child: _buildDetailItem(
                  context: context,
                  title: 'minDuration'.tr(),
                  value: plan.minDurationMonths < 12
                      ? '${plan.minDurationMonths}m'
                      : '${plan.minDurationMonths ~/ 12}y',
                ),
              ),
            ],
          ),
